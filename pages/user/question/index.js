...
Page({
    ...
    list:[
      {
        ...
        "child": [
          ...
          },
          {
            ...
            name: '一级和二级客户定义',
            open: false,
            contents: "一级客户：VIP或SVIP直接发展的客户或者VIP为自己的一级客户；\n二级客户：VIP或者SVIP的下级VIP或者SVIP发展的一级客户或者VIP为自己的二级客户。\n注：只有VIP和SVIP可以发展下级客户，且你的一级客户升级为SVIP后，将变为你的二级客户。"
          },
          {
            id: '04',
            name: '我的账户相关定义',
            open: false,
            contents: "我的账户：智淘系统的资金管理工具，记录VIP和SVIP在智淘助手小程序的资金数据。\n可用佣金：从淘宝订单交易成功、无退换货申请且过了维权期中获得的佣金和推荐SVIP获得的佣金，已减去退款返还的佣金，即账户内可申请提现至自己的收款账户的金额。\n待确认佣金：从淘宝支付成功的订单中获得的佣金，在交易成功、无退换货申请且过了维权期后，进入可用佣金。\n提现中：已经申请提现，未到账的金额。\n已提现：已经申请提现，并且已经到账的金额。\n累计佣金：从淘宝订单交易成功、无退换货申请且过了维权期中获得的佣金和推荐SVIP获得的佣金的累计总佣金。"
          },
        ]
      },
      {
        ...
        "child": [
          {
            ...
            name: '淘宝购物如何省钱',
            open: false,
            contents: "1、在淘宝或天猫选好商品后，复制商品标题；\n2、打开微信进入智淘助手小程序，立即搜索找到该商品并进入商品详情页；\n3、点击右下角按钮然后复制淘口令，再次打开手机淘宝，领取优惠券完成下单；\n4、正常交易完成后，回智淘助手小程序可获得相应佣金，随时可申请提现到微信零钱。备注：普通客户只能领取优惠券；智淘VIP和SVIP，能领取优惠券且购物下单可以获得返佣。"
          },
          {
            id: '06',
            name: 'SVIP如何赚钱',
            open: false,
            contents: "分享二维码：SVIP可以将二维码图片发送给微信好友或分享至朋友圈，好友扫码进入智淘助手小程序后即成为自己的客户，客户通过智淘助手购物省钱即可按照一定比率获得佣金，且客户申请成为SVIP也可获得相应奖励。分享智淘小程序页面：将智淘小程序链接发送给微信好友，好友进入智淘小程序后即成为自己的客户，客户通过智淘助手购物省钱即可按照一定比率获得佣金，且客户申请成为SVIP也可获得相应奖励。\n注：客户首次进入智淘助手小程序后即绑定关系链，关系链不能改变。"
          },
          {
            id: '07',
            name: '推荐SVIP的奖励是多少',
      ...
      },
      {
        ...
        "child": [
          ...
          },
          {
            ...
            name: '商品返佣何时到账',
            open: false,
            contents: "商品返佣的到账时间，是以淘宝订单交易成功且无退换货申请为前提的正常时间：\n到账周期：对于部分信用较好的用户，淘宝部分订单在确认收货后即可返佣到账，部分淘宝订单在订单过了维权期后返佣到账，时间在确认收货后的1天—20天，给你带来不便，我们深表歉意。\n预估到账时间：可进入我的页面“收入明细”查看具体淘宝订单佣金预估到账时间。如果你超过上述周期仍未获得返佣，请在智淘助手小程序联系客户，我们将第一时间帮你排查原因并处理。"
          },
          {
            id: '13',
  ...
  getList(){
    let that = this
    app.request({url:list,function(res){
      console.log(res)
    }})
  },
